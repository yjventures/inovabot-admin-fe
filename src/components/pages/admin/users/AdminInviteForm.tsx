...
import { useInviteAdminMutation } from '@/redux/features/usersApi'
...
export default function AdminInviteForm() {
  ...
  const [sendInvitation, { isLoading, isSuccess, isError, error }] = useInviteAdminMutation()
  ...
  return showEmailCheck ? (
    ...
    <FormWrapper>
      <Form methods={methods} onSubmit={handleSubmit(onSubmit)}>
        <DashboardHeading title='Admin information' variant='h4' />
